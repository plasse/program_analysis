...
(* OASIS_START *)
(* DO NOT EDIT (digest: 31507f8e0664bbaf2435ee122bb88252) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          bugreports = None;
          synopsis = "Program Analysis Study 2017 Summer";
          description = None;
          tags = [];
          categories = [];
          files_ab = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Ast"; "Parser"; "Lexer"; "Playground"];
                      lib_pack = false;
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\031ùòéa( _È`Ñ\129\143M9;";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
